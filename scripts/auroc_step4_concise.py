...
fps, tps, thresholds = _binary_clf_curve(
        golds, probs, pos_label=1) # function from sklearn.metrics._ranking, a binary classification curve
...
'''
code that collects metrics, 
Note probs_for_eval (model predictions) and golds_for_evals (labels), are global variables.
n: int, bootstrapping variable
'''
...
def get_points(probs_for_eval, golds_for_eval, n_boot=2):
    ...
    probably unneccessary, because I'm not bootstrapping much to get plots
    '''
